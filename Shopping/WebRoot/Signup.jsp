	...
	<div class="loginMain">
		...
		<form action="Tb_managerServlet?f=login" method="post" id="form1">
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<tr><td class="title">密码确认：</td><td><input type="password" id="txtPwd" name="txtPwd" class="form-control txt" /></td></tr>
				...
				<tr><td>&nbsp;</td><td><input type="button" class="loginbtn" value="注册""/>
